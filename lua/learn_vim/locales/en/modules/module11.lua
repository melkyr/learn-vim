...
-- lua/learn_vim/locales/en/modules/module11.lua
        ...
        exercises = {
            {
                ...
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise1_setup.txt")),
                start_cursor = {5, 0},
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise2_setup.txt")),
                start_cursor = {7, 4}, -- Cursor on 'm' of mov eax, 1
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise3_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on 'P' of the first PRINT
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson1_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise1_setup.txt")),
                start_cursor = {8, 7}, -- Cursor on the first space of DISPLAY
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise2_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on the first '(' of the let form
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise3_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on the first line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson2_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise1_setup.txt")),
                start_cursor = {5, 0},
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise2_setup.txt")),
                start_cursor = {7, 4}, -- Cursor on 'v' of the first 'var'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise3_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on the first '('
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson3_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise1_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on 'm' of message
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise2_setup.txt")),
                start_cursor = {7, 8}, -- Cursor on the first space before "Alice"
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise3_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'l' of the first 'let'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson4_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson5_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on the first line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson5_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson5_exercise2_setup.txt")),
                start_cursor = {8, 0}, -- Cursor on 'export default {'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson5_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson6_exercise1_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on the first space of msg db
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson6_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson6_exercise2_setup.txt")),
                start_cursor = {6, 0}, -- Cursor on 'i' of the first 'int'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson6_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson7_exercise1_setup.txt")),
                start_cursor = {7, 0}, -- Cursor on the line 'x = 10'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson7_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson7_exercise2_setup.txt")),
                start_cursor = {8, 7}, -- Cursor on the DISPLAY line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson7_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson8_exercise1_setup.txt")),
                start_cursor = {5, 1}, -- Cursor on 'd' of defun
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson8_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson8_exercise2_setup.txt")),
                start_cursor = {7, 0}, -- Cursor on the ancestor(X, Y) :- parent(X, Y). line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson8_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson9_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'x'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson9_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson9_exercise2_setup.txt")),
                start_cursor = {10, 4}, -- Cursor on the last line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson9_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson10_exercise1_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on the println "Hello" line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson10_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson10_exercise2_setup.txt")),
                start_cursor = {6, 6}, -- Cursor on 'g' of greet
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson10_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson11_exercise1_setup.txt")),
                start_cursor = {7, 8}, -- Cursor on the first case branch line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson11_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson11_exercise2_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on the 'let name' line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson11_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson12_exercise1_setup.txt")),
                start_cursor = {6, 12}, -- Cursor on the ';' after id: string
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson12_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson12_exercise2_setup.txt")),
                start_cursor = {6, 12}, -- Cursor on 'm' of message
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson12_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson13_exercise1_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on the msg db line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson13_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson13_exercise2_setup.txt")),
                start_cursor = {7, 4}, -- Cursor on the return line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson13_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson14_exercise1_setup.txt")),
                start_cursor = {5, 35}, -- Cursor after "the "
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module11_lesson14_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module11_lesson14_exercise2_setup.txt")),
                start_cursor = {5, 17}, -- Cursor on '[' of [Your Name]
                validation = {
                    type = 'check_buffer_content_regex', -- Need regex validation
                    target_content_pattern = Utils.read_file_content(get_exercise_path("module11_lesson14_exercise2_target.txt"))
                },
