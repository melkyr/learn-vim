...
return {
    -- Module 0
    module0_title = "Module 0: Essential First Steps",

    -- Module 0, Lesson 1
    module0_lesson1_title = "Exiting Vim: Your Essential Escape Routes",
...
- These exit commands (`:q`, `:q!`, `:wq`, `:x`) won't actually close the tutorial environment but will be checked as if you typed them.
    ...
    module0_lesson1_exercise1_instruction = "You've made some imaginary changes and want to exit without saving. Type `:q!` and press <Enter>. Then type `:LearnVim exc` to check.",
    module0_lesson1_exercise1_feedback = "Correct! `:q!` is the way to force quit without saving. You're not trapped!",
    module0_lesson1_exercise2_instruction = "Now, imagine you've finished your work and want to save and exit. Type `:wq` and press <Enter>. Then type `:LearnVim exc` to check.",
    module0_lesson1_exercise2_feedback = "Excellent! `:wq` saves your work and quits. You've mastered exiting Vim!",

    -- Module 0, Lesson 2
    module0_lesson2_title = "Moving Around: Up, Down, Left, Right",
...
It takes practice, but these will become second nature. Try to avoid using the arrow keys!
    ...
    module0_lesson2_exercise1_instruction = "Use h, j, k, l to navigate to the character '[X]' in the text below. Once your cursor is on '[X]', press 'r' (replace mode) then 'O' (the capital letter O) to change it to '[O]'. Press <Esc> to return to Normal mode. Then type :LearnVim exc to check.",
    module0_lesson2_exercise1_feedback = "Great job! You've successfully navigated and made a change using basic motion keys.",

    -- Module 0, Lesson 3
    module0_lesson3_title = "Jumping Further: Words and Lines",
...
Try these out! They significantly speed up navigation within lines.
    ...
    module0_lesson3_exercise1_instruction = "The cursor will start at the beginning of the second line. Use 'w' to move to the beginning of the third word ('several'). Then type 'cw' (change word), type 'many', and press <Esc>. Then type :LearnVim exc to check.",
    module0_lesson3_exercise1_feedback = "Perfect! 'w' and 'cw' are a powerful combo.",
    module0_lesson3_exercise2_instruction = "The cursor will start at the beginning of the last line. Use '$' to move to the end of the line (after '[TARGET_EOL]'). Then press 'a' (append), type ' ADDED_TEXT', and press <Esc>. Then type :LearnVim exc to check.",
    module0_lesson3_exercise2_feedback = "Excellent! '$' takes you right to the end, and 'a' lets you append.",

    -- Module 0, Lesson 4
    module0_lesson4_title = "Seeing the Big Picture: Navigating Files",
...
Mastering these will make you feel like you're flying through your files!
    ...
    module0_lesson4_exercise1_instruction = "You'll start somewhere in the middle of a long file. Go to the very TOP of the file using 'gg'. The first line contains '=== TOP OF THE FILE ==='. Change the 'T' in 'TOP' to 'X'. Press <Esc>. Then type :LearnVim exc to check.",
    module0_lesson4_exercise1_feedback = "Zap! 'gg' takes you straight to the top!",
    module0_lesson4_exercise2_instruction = "You'll start somewhere in the middle. Go to the very BOTTOM of the file using 'G'. The last line contains '=== BOTTOM OF THE FILE ==='. Change the 'B' in 'BOTTOM' to 'Y'. Press <Esc>. Then type :LearnVim exc to check.",
    module0_lesson4_exercise2_feedback = "Zoom! 'G' drops you right at the end!",
    module0_lesson4_exercise3_instruction = "You'll start at the top of the file. Scroll down a bit if needed to make sure there's text above and below your current view. Then, move your cursor to the MIDDLE line of the CURRENT SCREEN using 'M'. The line should be 'This is line 35. [SCREEN_MIDDLE_TARGET]'. Change the '[S]' in '[SCREEN_MIDDLE_TARGET]' to '[Z]'. Press <Esc>. Then type :LearnVim exc to check. (Note: exact line for 'M' depends on your screen size, the setup text has a marker.)",
    module0_lesson4_exercise3_feedback = "Nicely done! 'M' helps you orient yourself on the screen quickly.",
}
