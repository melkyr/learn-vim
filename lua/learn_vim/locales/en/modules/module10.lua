...
-- lua/learn_vim/locales/en/modules/module10.lua
        ...
        exercises = {
            {
                ...
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson1_exercise1_setup.txt")),
                start_cursor = {5, 0},
        ...
        exercises = {
            {
                ...
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson2_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'D' of 'DELETE'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson2_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson2_exercise2_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on "Delete this line 1."
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson2_exercise2_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'p' of the first 'print'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise2_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on the first '<' of <li>
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise3_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 'l' of the first 'let'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson3_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise1_setup.txt")),
                start_cursor = {8, 18}, -- Cursor on 'i' of 'int' in numbers1
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise2_setup.txt")),
                start_cursor = {6, 2}, -- Cursor on 'f' of the first 'final'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise3_setup.txt")),
                start_cursor = {5, 38}, -- Cursor on 't' of the first 'true'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson4_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'p' of the first 'public'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise2_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 'l' of the first 'let'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise3_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 'v' of the first 'var'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson5_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'p' of the first 'puts'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise2_setup.txt")),
                start_cursor = {6, 0}, -- Cursor on the '$' of $name
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise3_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 's' of the first 'std::'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson6_exercise3_target.txt"))
                },
        ...
        exercises = {
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise1_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'p' of the first 'public'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise2_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 'v' of the first 'val'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise3_setup.txt")),
                start_cursor = {5, 0}, -- Cursor on 'e' of the first 'echo'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson7_exercise3_target.txt"))
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise1_setup.txt")),
                start_cursor = {5, 1}, -- Cursor on 'd' of the first 'define'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise1_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise2_setup.txt")),
                start_cursor = {6, 11}, -- Cursor on 'i' of the first 'int'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise2_target.txt"))
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise3_setup.txt")),
                start_cursor = {6, 4}, -- Cursor on 'p' of the first 'println'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content(get_exercise_path("module10_lesson8_exercise3_target.txt"))
                },
