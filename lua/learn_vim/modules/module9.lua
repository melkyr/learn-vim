        ...
        exercises = {
            {
                ...
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise1_setup.txt"),
                start_cursor = {6, 4}, -- Cursor on the first line of the body
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise1_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise2_setup.txt"),
                start_cursor = {6, 0}, -- Cursor on the first space of the first <li>
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise2_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise3_setup.txt"),
                start_cursor = {6, 4}, -- Cursor on 'l' of 'let'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson1_exercise3_target.txt")
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson2_exercise1_setup.txt"),
                start_cursor = {5, 0}, -- Cursor on "Block 1 Line 1"
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson2_exercise1_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson2_exercise2_setup.txt"),
                start_cursor = {5, 0}, -- Cursor on "Line A1"
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson2_exercise2_target.txt")
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise1_setup.txt"),
                start_cursor = {6, 8}, -- Cursor on the '('
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise1_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise2_setup.txt"),
                start_cursor = {5, 34}, -- Cursor on the '(' after VALUES
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise2_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise3_setup.txt"),
                start_cursor = {7, 24}, -- Cursor on the '{' of the if statement
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson4_exercise3_target.txt")
                },
        ...
        exercises = {
            {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise1_setup.txt"),
                start_cursor = {6, 2}, -- Cursor on 'p' of 'print'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise1_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise2_setup.txt"),
                start_cursor = {8, 17}, -- Cursor on 'i' of 'int'
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise2_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise4_setup.txt"),
                start_cursor = {6, 0}, -- Cursor on 'F' of FROM
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise4_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise6_setup.txt"),
                start_cursor = {6, 4}, -- Cursor on 'v' of var name
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise6_target.txt")
                },
            ...
            },
             {
                ...
                type = "cursor_move", -- Check cursor position
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise7_setup.txt"),
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise8_setup.txt"),
                start_cursor = {7, 4}, -- Cursor on the '$' of $sum
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise8_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise10_setup.txt"),
                start_cursor = {8, 12}, -- Cursor on 'C' of Console.WriteLine("Hello")
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise10_target.txt")
                },
            ...
            },
             {
                ...
                type = "insert_text", -- Check buffer content
                setup_text = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise12_setup.txt"),
                start_cursor = {5, 0}, -- Cursor on the '#' of the first line
                validation = {
                    type = 'check_buffer_content',
                    target_content = Utils.read_file_content("lua/learn_vim/exercise_content/module9_lesson5_exercise12_target.txt")
                },
