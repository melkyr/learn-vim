...
vim.api.nvim_create_user_command('LearnVim', function(opts)
    ...
    elseif args_string == 'language' then
        learn_vim.display_language_menu()
    elseif args_string == 'motion' then
        ...
        vim.notify("Usage: :LearnVim [start | next | prev | restart | exc | exr | lesson <module>.<lesson> | contents | motion | language]", vim.log.levels.INFO)
    end
end, {
